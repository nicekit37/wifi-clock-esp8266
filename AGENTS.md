...
├─ include/
│  └─ User_Setup.h          # Настройки TFT_eSPI (ST7789, пины, SMOOTH_FONT)
├─ lib/
│  ├─ TFT_eSPI/             # Вендорная копия TFT_eSPI 2.5.43 (см. lib/TFT_eSPI/PATCHES.md)
│  ├─ User_Setup.h          # Редирект → include/User_Setup.h
...
| `include/User_Setup.h` | Аппаратно‑зависимые настройки TFT_eSPI (разрешение, пины, `SMOOTH_FONT`). |
...
- При работе с дисплеем учитывайте аппаратные настройки из `include/User_Setup.h`.
