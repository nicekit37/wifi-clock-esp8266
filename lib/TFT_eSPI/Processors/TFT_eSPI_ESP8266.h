...
#ifdef SMOOTH_FONT
  // Вендор-патч: шрифты только из массивов (loadFont), без SPIFFS/LittleFS в Smooth_font.
  // Не определять FONT_FS_AVAILABLE — убирает deprecated SPIFFS в Smooth_font.h.
#endif
