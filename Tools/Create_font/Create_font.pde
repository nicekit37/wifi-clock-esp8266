...
String fontType = ".ttf";
int fontSize = 60;  // Размер шрифта (изменить по необходимости: 10, 12, 15, 20, 40 и т.д.)
int displayFontSize = 60;  // Размер для предварительного просмотра
...
static final int[] specificUnicodes = {
  ...
  0x003A,  // : двоеточие (для времени: "%02d:%02d", для uptime: "Xd:XX")
...
void setup() {
  ...
  println("  - Numbers: 0-9");
  println("  - Signs: пробел, !, %, +, -, ., :");
  println("  - Latin: d, w (для uptime)");
