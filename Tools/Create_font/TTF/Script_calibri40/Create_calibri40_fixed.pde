// Скрипт для создания шрифта Calibri40
// Настройки: размер 40, символы: -, I, М, З, А, Т, С, О, В
...
String fontType = ".ttf";
int fontSize = 40;  // Размер шрифта
int displayFontSize = 25;  // Размер для предварительного просмотра
...
static final int[] unicodeBlocks = {
  // Пустой массив - цифры не нужны
};

static final int[] specificUnicodes = {
  0x002D, // - (знак минус)
  0x0049, // I (английская буква I)
  0x041C, 0x0417, 0x0410, 0x0422, 0x0421, 0x041E, 0x0412, // М З А Т С О В (кириллические буквы)
};
...
void setup() {
  ...
  println();
  println("=====================");
  println("Creating Calibri40 FIXED font file...");
  ...
  String headerFilePath = "G:/proshifki/2025/SERGEEV/221025/new/TS/src/";
  ...
  try{
    ...
    PrintWriter output = createWriter(headerFilePath + "calibri40.h");
