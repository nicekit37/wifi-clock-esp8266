// Скрипт для создания шрифта Calibri40 с оптимальным набором символов
// Настройки: размер 40, цифры, английский и русский алфавит, основные знаки
...
void setup() {
  ...
  println();
  println("=====================");
  println("Creating Calibri40 OPTIMAL font file...");
