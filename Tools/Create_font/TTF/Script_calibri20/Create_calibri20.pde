// Скрипт для создания шрифта Calibri20
// Настройки: размер 20, символы: цифры 0-9, !, %, -, +, :, I, кириллические буквы для УВАГА, АВАРIЯ, ТС, О, Н, Л, Е, Я, Р
...
static final int[] specificUnicodes = {
  0x0021, 0x0025, 0x002D, 0x002B, 0x003A, // ! % - + : (восклицательный знак, процент, дефис, плюс, двоеточие)
  0x0049, // I (английская буква I)
  0x0406, // І (украинская буква I)
  0x0423, 0x0412, 0x0410, 0x0413, // У В А Г (кириллические буквы для УВАГА и АВАРIЯ)
  0x041E, // О (кириллические буквы)
  0x041D, 0x041B, 0x0415, 0x042F, 0x0420, // Н Л Е Я Р (дополнительные кириллические буквы)
};
...
void setup() {
  ...
  println();
  println("=====================");
  println("Creating Calibri20 font file...");
  ...
  try{
    ...
    PrintWriter output = createWriter(headerFilePath + "calibri20.h");
