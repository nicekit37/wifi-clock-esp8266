// Упрощенная версия скрипта для создания шрифта DigitalMono7
// Настройки: размер 50, символы: цифры 0-9, точка, буква C

import java.awt.Desktop;

// Настройки шрифта
String fontName = "Digital";
String fontType = ".ttf";
int fontSize = 50;  // Высота символа
int displayFontSize = 30;  // Размер для предварительного просмотра
...
static final int[] specificUnicodes = {
  0x002E, 0x0043, // . C (точка и буква C)
};
...
void setup() {
  ...
  try{
    ...
    PrintWriter output = createWriter(headerFilePath + "digital50.h");
