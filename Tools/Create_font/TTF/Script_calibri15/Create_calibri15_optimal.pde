// Скрипт для создания шрифта Calibri15 с оптимальным набором символов
// Настройки: размер 15, цифры, английский и русский алфавит, основные знаки
...
void setup() {
  ...
  println();
  println("=====================");
  println("Creating Calibri15 OPTIMAL font file...");
