// Скрипт для создания шрифта Calibri12
// Настройки: размер 12, символы: цифры 0-9, !, %, -, кириллические буквы для УВАГА, МИЗ-МА, ТС, О
...
int displayFontSize = 8;  // Размер для предварительного просмотра
...
static final int[] specificUnicodes = {
  0x0021, 0x0025, 0x002D, // ! % - (восклицательный знак, процент, дефис)
  0x0423, 0x0412, 0x0410, 0x0413, // У В А Г (кириллические буквы для УВАГА)
  0x041C, 0x0418, 0x0417, // М И З (кириллические буквы для МИЗ-МА)
  0x0422, 0x0421, 0x041E, // Т С О (кириллические буквы)
};
...
void setup() {
  ...
  println();
  println("=====================");
  println("Creating Calibri12 font file...");
