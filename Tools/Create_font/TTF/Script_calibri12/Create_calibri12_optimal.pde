// Скрипт для создания шрифта Calibri12 с оптимальным набором символов
// Настройки: размер 12, цифры, английский и русский алфавит, основные знаки
...
void setup() {
  ...
  println();
  println("=====================");
  println("Creating Calibri12 OPTIMAL font file...");
