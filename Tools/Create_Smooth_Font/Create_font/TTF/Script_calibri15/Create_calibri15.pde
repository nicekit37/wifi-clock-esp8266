// Скрипт для создания шрифта Calibri15
// Настройки: размер 15, символы: цифры 0-9, +, -, %, .
...
static final int[] specificUnicodes = {
  0x002B, 0x002D, 0x0025, 0x002E, // + - % . (плюс, минус, процент, точка)
};
...
void setup() {
  ...
  println();
  println("=====================");
  println("Creating Calibri15 font file...");
  ...
  try{
    ...
    PrintWriter output = createWriter(headerFilePath + "calibri15.h");
